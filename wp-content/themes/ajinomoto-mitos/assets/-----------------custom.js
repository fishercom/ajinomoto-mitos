document.addEventListener('DOMContentLoaded', () => {
    ...
    function moverIndicadorPestana(tabId) {
        ...
        // Calculamos las geometrías exactas del div activo
        const contenedorRect = contenedor.getBoundingClientRect();
        const pestañaRect = pestañaActiva.getBoundingClientRect();
        const desplazamientoX = pestañaRect.left - contenedorRect.left;
        const desplazamientoY = pestañaRect.top - contenedorRect.top; // Por si hay desfase vertical
    
        // Seteamos las dimensiones idénticas al div de la pestaña
        indicador.style.width = `${pestañaRect.width}px`;
        indicador.style.height = `${pestañaRect.height}px`;
        
        // Usamos transform para posicionarlo de forma ultra suave
